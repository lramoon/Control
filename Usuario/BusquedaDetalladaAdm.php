...
<br>
                    <form  method="" action="">
                    <fieldset class="CFormulario"><legend><h2 style='color:white; background-color:rgba(0,0,0,0.5);'>Administrador</h2></legend>
    ...
    $tbl_name = "usuario_a";
     ...
     $buscarUsuario = "SELECT * FROM $tbl_name WHERE user = '".$user."'";
      ...
      echo "</tr>";
                    ...
                    location.href='MostrarConsulta_E.php';
                  </script>";
                  }
...
?>
 ...
 <a href="MostrarConsulta_E.php"><button class="btn">Volver</button></a>
