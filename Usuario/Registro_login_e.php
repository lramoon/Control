...
<!--inicio contenido-->
<div>
                <h1 style="background-color:rgba(0,0,0,0.5)" class="title text-center">Nuevo usuario</h1>
                <div class="scroll">
                <form id="Formulario" method="post" action="../Conexiones/Registro_login_e.php">
                    <fieldset class="CFormulario"><legend><h2  style="color:white; background-color:rgba(0,0,0,0.5);">Registro usuario</h2></legend>
