...
?>
<title>Mostrar Asistencia</title>
 <br>
 <br>
                 <h1 style="color:white; background-color:rgba(0,0,0,0.5);"> Consulta de Asistencia </h1>
<div>
<br>
                    <form  method="" action="">
  ...
  function ConsultarProducto($cedula)
  {
    ...
    $tbl_name2 = "asistencia_salida";
     ...
     $buscarUsuario = "SELECT AEn.cedula, AEn.Fecha_entrada, ASa.Fecha_salida FROM $tbl_name AEn  
                    INNER JOIN $tbl_name2 ASa  ON AEn.id = ASa.id WHERE AEn.cedula = '".$cedula."'";
      ...
      echo "<td> <a href='../generarPDF/generaUno.php?cedula=".$cedula."'><button class='btn' type='button' class='btn-Act'>Generar Reporte</button></a> </td>";  
...
<br>
 <a href="Asistencia.php"> <button class="btn"> ATRAS </button></a>
