...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de Asistencias General',0,0,'C');
    // Salto de línea
    $this->Ln(20);
    //Nombre del ADM
...
function ConsultarProducto()
  {
    $host_db = "localhost";
     ...
     $buscarUsuario = "SELECT NEm.Nombre, NEm.Apellido,  AEn.cedula, AEn.Fecha_entrada, ASa.Fecha_salida FROM $tbl_name AEn
                    INNER JOIN $tbl_name2 ASa ON AEn.id = ASa.id INNER JOIN $tbl_name3 NEm ON NEm.Cedula = ASa.cedula";
